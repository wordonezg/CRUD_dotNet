...
<ControlStyle CssClass="btn btn-info"></ControlStyle>
            ...
            <asp:TemplateField ShowHeader="False">
                <ItemTemplate>
                    <asp:Button ID="btn_eliminar" runat="server" CausesValidation="False" CommandName="Delete" Text="Eliminar" OnClientClick="javascript:if(!confirm('¿Seguro que quiere Eliminar?'))return false" />
                </ItemTemplate>
